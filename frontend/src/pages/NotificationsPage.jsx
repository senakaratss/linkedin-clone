  ...
  const renderRelatedPost = (relatedPost) => {
    ...
    return (
      <Link
        ...
        className="flex items-center gap-2 p-2 mt-2 bg-gray-100 hover:bg-gray-200 transition-colors rounded"
      >
        {relatedPost.image && (
          <img
                    ...
                    <div className="flex gap-2">
                      {!notification.read && (
                        <button
                          ...
                          className="p-1 bg-blue-600 rounded hover:bg-blue-200 transition-colors"
