...
const ProfileHeader = ({ userData, onSave, isOwnProfile }) => {
  ...
  const renderConnectionButton = () => {
    const baseClass =
      "text-white px-4 py-2 rounded-full transition duration-300 flex items-center justify-center";
    switch (getConnectionStatus()) {
      ...
      case "received":
        return (
          <div className="flex gap-2 justify-center">
            <button
              className={`${baseClass} bg-green-500 hover:bg-green-600 text-sm`}
      ...
      default:
        return (
          <button
            ...
            className="bg-primary hover:bg-primary-dark text-white px-4 py-2 rounded-full transition duration-300 flex items-center justify-center"
          >
      ...
      <div className="p-4">
        ...
        <div className="text-center mb-4">
          ...
          <div className="flex justify-center items-center mt-2">
            <MapPin size={16} className="tex-gray-500 mr-1" />
            {isEditing ? (
              <input
                type="text"
        ...
        {isOwnProfile ? (
          isEditing ? (
            <button
              onClick={handleSave}
              className=" w-full bg-primary hover:bg-primary-dark text-white px-4 py-2 rounded-full transition duration-300"
            >
              Save Profile
            </button>
          ) : (
